...
<body>
	...
	<div class = "col-md-7">
		<form name="updateProduct" class = "form-horizontal" action="./processUpdateProduct.jsp"
		method = "post" enctype="multipart/form-data">
			...
			<div class = "form-group row">
				<label class = "col-sm-2">게임 설명</label>
				<div class = "col-sm-5">
			...
			<div class = "form-group row">
				...
				<div class = "col-sm-3">
					...
					class = "form-control" value='<%=rs.getString("p_producer") %>'>
				</div>
			</div>
			<div class = "form-group row">
				<label class = "col-sm-2">장르</label>
				<div class = "col-sm-3">
					<input type="text" id="unitPrice" name="genre"
					class = "form-control" value='<%=rs.getString("p_genre") %>'>
				</div>
			</div>
			<div class = "form-group row">
